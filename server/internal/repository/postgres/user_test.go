...
func TestUserRepository_List_WithFilters(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT id, oidc_provider_id, subject, name, created_at, updated_at\s+FROM users\s+WHERE 1=1 AND subject = \$1 AND oidc_provider_id = \$2 ORDER BY created_at DESC`).
...
func TestUserRepository_List_WithNameFilter(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT id, oidc_provider_id, subject, name, created_at, updated_at\s+FROM users\s+WHERE 1=1 AND subject = \$1 AND oidc_provider_id = \$2 AND name = \$3 ORDER BY created_at DESC`).
...
func TestUserRepository_Create(t *testing.T) {
	...
	mock.ExpectQuery(`INSERT INTO users \(oidc_provider_id, subject, name\)\s+VALUES \(\$1, \$2, \$3\)\s+RETURNING id, oidc_provider_id, subject, name, created_at, updated_at`).
		WithArgs("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", "google-subject-1", "Test User").
		WillReturnRows(rows)
...
func TestUserRepository_GetByID(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT id, oidc_provider_id, subject, name, created_at, updated_at\s+FROM users\s+WHERE id = \$1`).
...
func TestUserRepository_UpdateName(t *testing.T) {
	...
	mock.ExpectQuery(`UPDATE users\s+SET name = \$1, updated_at = NOW\(\)\s+WHERE id = \$2\s+RETURNING id, oidc_provider_id, subject, name, created_at, updated_at`).
...
func TestUserRepository_Search_ByName(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT id, oidc_provider_id, subject, name, created_at, updated_at\s+FROM users WHERE \(name ILIKE \$1\) ORDER BY name NULLS LAST, created_at DESC LIMIT \$2`).
		WithArgs("%ali%", 20).
		WillReturnRows(rows)
