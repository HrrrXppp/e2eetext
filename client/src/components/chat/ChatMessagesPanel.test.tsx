...
const messagesWithUnread = [
  {
    ...
    userName: "Alice",
    data: "ciphertext-1",
    kemCiphertext: "kem-ciphertext-1",
    plaintext: "read message",
    createdAt: "2026-06-11T12:00:00.000Z",
    updatedAt: "2026-06-11T12:00:00.000Z",
    unread: false,
  },
  {
    ...
    data: "ciphertext-2",
    kemCiphertext: "kem-ciphertext-2",
    plaintext: "unread message",
      ...
      <ChatMessagesPanel
        ...
        messages={[
          ...messagesWithUnread,
          {
            ...
            userId: "99999999-9999-9999-9999-999999999999/other-user",
            data: "ciphertext-3",
            kemCiphertext: "kem-ciphertext-3",
            plaintext: "another unread",
