...
description: Acts as a senior React software engineer for components, hooks, state, performance, testing, accessibility, and code review. Use when writing or reviewing React code, .tsx/.jsx files, hooks, JSX, Next.js, React Router, or when the user asks for React best practices.
...
4. Run lint and tests (`npm test`, `vitest`, `eslint`) when available
